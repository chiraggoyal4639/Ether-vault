...
contract TestEtherVault is Test{
   ...
   event Deposited(address indexed funder, uint amount);
   ...
   function simulateDeposit(address _user, uint _amount) public{
      vm.prank(_user);
